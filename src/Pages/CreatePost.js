          ...
          >
            <div className=" md:w-1/2 pt-10">
              ...
              <div className="">
                <div className="image-container flex gap-2 overflow-hidden flex-wrap">
                  {imagePreview.length > 0 ? (
                    imagePreview.map((url) => {
                      return (
                        <div className="empty-box h-32 w-32 bg-slate-50 rounded-md overflow-hidden ">
                          <img
                            src={url}
                            alt=""
                    ...
                    <div className="empty-box border dark:bg-base-100 border-gray-400 flex justify-center items-center h-32 w-32 bg-slate-50 rounded-md">
                      IMG
                    </div>
                  )}
                </div>
                <div>
                  <div
                    className="empty-box border border-gray-400 flex flex-col text-center justify-center items-center h-32 w-32 dark:bg-base-100 bg-slate-50 rounded-md cursor-pointer hover:dark:bg-base-200"
                    onClick={handleClick}
                  >
                    <div>+</div>
                    Upload IMG
...
//   // Options for doctor dropdown
//   const doctorOptions = [
//     { label: "Dr. Richa (Cardiologist)", value: "Cardiologist" },
//     { label: "Dr. Narayan (Neurologist)", value: "Neurologist" },
//     { label: "Dr. Satyam (General Physician)", value: "General Physician" },
//   ];

//   // Validation function for phone number
//   const validatePhoneNumber = (phoneNumber) => {
//     return /^\d{10}$/.test(phoneNumber); // Checks if the phone number is exactly 10 digits
//   };
